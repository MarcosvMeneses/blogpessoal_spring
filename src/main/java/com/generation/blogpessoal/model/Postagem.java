...
@Entity
@Table(name = "tb_postagens")//equivalente a usar um create table
public class Postagem {
	...
	@Column(length = 100)
	@NotBlank(message = "O tritubuto título é obrigatório!")
	@Size(min = 5, max = 100, message = "O atributo título deve ter no minimo 5 e no máximo 100 caracteres.")
	private String titulo;
	
	@Column(length = 1000)
	@NotBlank(message = "O tritubuto texto é obrigatório!")
